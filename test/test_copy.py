...
# @pytest.mark.parametrize("method,url,data,response_json", [
#     ("GET", "http://example.com", None, {"status": "success"}),
#     ("POST", "http://example.com", {"key": "value"}, {"status": "created"}),
# ])
# def test_send_request(method, url, data, response_json, monkeypatch):
#     """Test send_request with different HTTP methods."""
...
#     def mock_requests_request(m, u, json=None):
#         assert m == method
#         assert u == url
#         assert json == data
#         return MockResponse()
...
#     result = XTSAllocatorClient.send_request(method, url, data)
...
#     test_provided_args(client)
#     test_provided_positionals(client)
#     # test_send_request(client)
#     test_load_servers()
#     test_save_servers()
#     test_allocate_slot(None, client)
#     test_deallocate_slot(None, client)
